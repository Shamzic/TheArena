...
ALTER TABLE Tournament ADD CONSTRAINT AK_Tournament1 UNIQUE(Initials);
ALTER TABLE Tournament ADD CONSTRAINT AK_Tournament2 UNIQUE(Name);
...
ALTER TABLE Geek ADD CONSTRAINT AK_Geek1 UNIQUE(Username);
ALTER TABLE Geek ADD CONSTRAINT AK_Geek2 UNIQUE(Mail);
