...
ALTER TABLE Configuration ADD CONSTRAINT FK_Configuration1 FOREIGN KEY (Geek) REFERENCES Geek (GeekId);
...
ALTER TABLE Roles_Geek ADD CONSTRAINT FK_RG2 FOREIGN KEY (Geek) REFERENCES Geek (GeekId);

ALTER TABLE Team_Geek ADD CONSTRAINT FK_TG1 FOREIGN KEY (Team) REFERENCES Team (TeamId);
ALTER TABLE Team_Geek ADD CONSTRAINT FK_TG2 FOREIGN KEY (Player) REFERENCES Geek (GeekId);
