...
namespace TheArena.Attributes
{
    public class PeriodeAttributes : ValidationAttribute
    {
        public string otherPropertyName;
        public PeriodeAttributes() { }
        public PeriodeAttributes(string otherPropertyName, string errorMessage)
            : base(errorMessage)
        {
